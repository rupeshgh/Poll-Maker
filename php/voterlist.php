...
if(!empty($res) && $res->num_rows > 0){
 ...
 while($row= $res->fetch_assoc()){
  ...
  if($row['Poll_Name']==$_SESSION['Admin_Poll']){

    if($row['Poll_Type']=="FullControlled"){
...
<h1>For this Poll You can add more voters </h1>
 <button id="register"  type='submit'> Add voters </button>
